...
public class E512Mesh {
    ...
    public static Vector3[] GridVertice (int gx, int gy, float cx, float cy, bool half) {
    ...
    public static int[] GridTriangle (int gx, int gy, int layer, bool half) {
        int max_x = gx * (half ? 2 : 1);
        int max_y = gy * (half ? 2 : 1);
    ...
    public static Vector2[] GridUV (int gx, int gy, int layer, bool half) {
        int max_x = gx * (half ? 2 : 1);
        int max_y = gy * (half ? 2 : 1);
