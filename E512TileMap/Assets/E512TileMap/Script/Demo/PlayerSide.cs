...
public class PlayerSide : MonoBehaviour {
    ...
    void Update () {
        for (int i = 0; i < 1; ++i) {
            if (actiontype == 0 && (Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.RightArrow))) {
            ...
            if (actiontype == 1 && (Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.RightArrow)) && this.col.Test(16 * this.lr, 0).Count < 1) {
            ...
            if (actiontype == 2 && (Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.RightArrow)) && this.col.Test(16 * this.lr, 0).Count < 1) {
